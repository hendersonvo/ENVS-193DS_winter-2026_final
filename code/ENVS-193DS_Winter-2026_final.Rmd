...
We have determined that the model using only visual obstruction as a predictor to site usage was the best model, as it has the lowest AIC compared to the other three models. 
...
We can see that between weekdays and weekends, there does not seem to be a difference in the number of steps taken (Wilcoxon rank sum test, W = 247, p = 0.9738, $\alpha$ = 0.05).
